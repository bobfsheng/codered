...
import { useAuthSelector, useReduxDispatch, useUserSelector } from '@store'
...
const InvestCryptoScreen = ({ stockTicker }) => {
  ...
  return (
    <>
      <VirtualizedView
        ...
        <LinearGradient
          colors={['#5381D5', '#6A57B8', '#201A90', 'black']}
          ...
          <Pressable onPress={() => dispatch(userActions.setInformation({ infoId: 20 }))}>
            <CustomInputLabel text="Search stocks" big info crypto />
          </Pressable>
          <Pressable
            style={styles.textInputContainer}
            onPress={() => NavigationService.navigate('SelectTicker', { tab: 'invest' })}>
            <Icon
              type="FontAwesome"
              name="search"
              color={'black'}
            ...
            <View style={styles.textInput}>
              <Text
                ...
                {stockTicker || 'Search Company Name or Stock Symbol'}
              </Text>
            </View>
          </Pressable>
          <View
            ...
            <View>
              <Pressable
                ...
                <CustomInputLabel text="Quantity" big info crypto />
              </Pressable>
              <Controller
                control={control}
                errors={errors}
            ...
            <View>
              <Pressable
                ...
                <CustomInputLabel text="Order type" big info crypto />
              </Pressable>
              <View
                style={{
          ...
          {selectedOrderType === 'trailing_stop' && (
            <View
              ...
              <Pressable
                onPress={() => dispatch(userActions.setInformation({ infoId: 12 }))}>
                <CustomInputLabel text="Stop Loss" big info crypto />
              </Pressable>
              <Controller
                control={control}
                errors={errors}
          ...
          {selectedOrderType === 'limit' && (
            <View
              ...
              <Pressable
                onPress={() => dispatch(userActions.setInformation({ infoId: 12 }))}>
                <CustomInputLabel text="Limit Price" big info crypto />
              </Pressable>
              <Controller
                control={control}
                errors={errors}
